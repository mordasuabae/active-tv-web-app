                  ...
                  return (
                    ...
                    <Box style={{ display: "flex" }}>
                      ...
                      <Box className="Episodehover">
                        <img alt="img" src={episode.img} style={{ width: 400, height: 200, borderRadius: "25px", position: "relative", marginTop: "40px", cursor: "pointer", objectFit: "cover" }} />
                      ...
                      <Box style={{ marginLeft: "45px", color: "white", marginTop: "25px" }}>
